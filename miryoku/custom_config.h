...
&trans,   &kp NUM_7, &kp NUM_8, &kp NUM_9, &kp T, U_NU, U_NU, U_NU, U_NU, U_NU, \
&kp LALT, &kp NUM_4, &kp NUM_5, &kp NUM_6, &kp G, U_NU, U_NU, U_NU, U_NU, U_NU, \
&trans,   &kp NUM_1, &kp NUM_2, &kp NUM_3, &kp B, U_NU, U_NU, U_NU, U_NU, U_NU, \
